...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="/docs/src/public/logo-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="/docs/src/public/logo.svg">
    <img alt="AlgebraOfGraphics Logo" src="/docs/src/public/logo.svg" width="350">
  </picture>
</div>
```
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for how to get help, report bugs, and contribute code or documentation.
