...
<span class="line"><span>  upper       MakieCore.Automatic()</span></span></code></pre></div>`,5)),e(n,{type:"info",class:"source-link",text:"source"},{default:l(()=>s[6]||(s[6]=[a("a",{href:"https://github.com/MakieOrg/AlgebraOfGraphics.jl",target:"_blank",rel:"noreferrer"},"source",-1)])),_:1,__:[6]})])])}const y=t(d,[["render",g]]);export{v as __pageData,y as default};
