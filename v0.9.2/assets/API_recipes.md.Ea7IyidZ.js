import{_ as l,C as t,c as o,o as r,j as a,a as n,az as p,G as i}from"./chunks/framework.BxqUZRRL.js";const v=JSON.parse('{"title":"Recipes","description":"","frontmatter":{},"headers":[],"relativePath":"API/recipes.md","filePath":"API/recipes.md","lastUpdated":null}'),c={name:"API/recipes.md"},d={class:"jldocstring custom-block",open:""},h={class:"jldocstring custom-block",open:""};function u(g,s,k,b,f,m){const e=t("Badge");return r(),o("div",null,[s[6]||(s[6]=a("h1",{id:"recipes",tabindex:"-1"},[n("Recipes "),a("a",{class:"header-anchor",href:"#recipes","aria-label":'Permalink to "Recipes"'},"​")],-1)),a("details",d,[a("summary",null,[s[0]||(s[0]=a("a",{id:"AlgebraOfGraphics.choropleth",href:"#AlgebraOfGraphics.choropleth"},[a("span",{class:"jlbinding"},"AlgebraOfGraphics.choropleth")],-1)),s[1]||(s[1]=n()),i(e,{type:"info",class:"jlObjectType jlFunction",text:"Function"})]),s[2]||(s[2]=p(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">choropleth</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(geometries; transformation, attributes</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">...</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p>Choropleth map, where regions are defined by <code>geometries</code>. Use <code>transformation</code> to transform coordinates (see <a href="https://github.com/JuliaGeo/Proj.jl" target="_blank" rel="noreferrer">Proj.jl</a> for more information).</p><div class="warning custom-block"><p class="custom-block-title">Warning</p><p>The <code>transformation</code> keyword argument is experimental and could be deprecated (even in a non-breaking release) in favor of a different syntax.</p></div><p><strong>Attributes</strong></p><p>Available attributes and their defaults for <code>Plot{AlgebraOfGraphics.choropleth}</code> are:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  alpha               1.0</span></span>
...
<span class="line"><span>  visible             true</span></span></code></pre></div><p><a href="https://github.com/MakieOrg/AlgebraOfGraphics.jl" target="_blank" rel="noreferrer">source</a></p>`,7))]),a("details",h,[a("summary",null,[s[3]||(s[3]=a("a",{id:"AlgebraOfGraphics.linesfill",href:"#AlgebraOfGraphics.linesfill"},[a("span",{class:"jlbinding"},"AlgebraOfGraphics.linesfill")],-1)),s[4]||(s[4]=n()),i(e,{type:"info",class:"jlObjectType jlFunction",text:"Function"})]),s[5]||(s[5]=p(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">linesfill</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(xs, ys; lower, upper, attributes</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">...</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><p>Line plot with a shaded area between <code>lower</code> and <code>upper</code>. If <code>lower</code> and <code>upper</code> are not given, shaded area is between <code>0</code> and <code>ys</code>.</p><p><strong>Attributes</strong></p><p>Available attributes and their defaults for <code>Plot{AlgebraOfGraphics.linesfill}</code> are:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  color       :black</span></span>
<span class="line"><span>  colormap    :viridis</span></span>
<span class="line"><span>  colorrange  MakieCore.Automatic()</span></span>
...
<span class="line"><span>  upper       MakieCore.Automatic()</span></span></code></pre></div><p><a href="https://github.com/MakieOrg/AlgebraOfGraphics.jl" target="_blank" rel="noreferrer">source</a></p>`,6))])])}const A=l(c,[["render",u]]);export{v as __pageData,A as default};
