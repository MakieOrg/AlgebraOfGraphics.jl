...
- Added support for input data with units attached, either through Unitful.jl or DynamicQuantities.jl extensions which raise the Julia lower bound to 1.9 [#619](https://github.com/MakieOrg/AlgebraOfGraphics.jl/pull/619).
