...
- Added `selection` transformation for filtering data based on predicates/transform functions where groups or observations can be dropped directly or only the top/bottom N groups or observations are kept given some sortable output.
